...
type ConfigSet struct {
	...
	TelegramMetricsListenAddr            string  `yaml:"telegram-metrics-listen-addr"`
	TelegramSubscriptionCheckIntervalSec int     `yaml:"telegram-subscription-check-interval-sec"`
	...
	TelegramCleanupProtectSec            int     `yaml:"telegram-cleanup-protect-sec"`
}
